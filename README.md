...
# Bitstamp Pro websocket API client [![Build Status](https://travis-ci.org/ColossusFX/bitstamp-client-websocket.svg?branch=master)](https://travis-ci.org/ColossusFX/bitstamp-client-websocket) [![NuGet version](https://badge.fury.io/nu/Bitstamp.Client.Websocket.svg)](https://badge.fury.io/nu/Bitstamp.Client.Websocket)

This is a C# implementation of the Bitstamp Pro websocket API found here:

https://docs.pro.bitstamp.com

[Releases and breaking changes](https://github.com/ColossusFX/bitstamp-client-websocket/releases)
